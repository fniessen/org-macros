...
check: test
	$(EMACS_BATCH) \
		--eval "(require 'org)" \
		--eval "(dolist (file '(\"README.org\" \"TODO-org-macros.org\" \"tests/all-macros.org\" \"org/setup/org-macros.setup\")) (with-temp-buffer (insert-file-contents file) (org-mode) (org-element-parse-buffer) (princ (format \"%s: clean\\n\" file))))"
	git diff --check
