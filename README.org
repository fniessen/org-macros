...
The =fixme= macro inserts a "FIXME" image.

*** Code

#+begin_src org
,#+MACRO: fixme @@html:<img class="icon" alt="FIXME" src="images/fixme.png" style="display: inline;"/>@@
#+end_src
...
The =hl= macro allows you to change the background color of inline text.
...
XXX {{{hl(This information is important.)}}}
