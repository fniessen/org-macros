...
,#+MACRO: k @@latex:\keys{$1}\xspace{}@@@@html:<kbd>$1</kbd>@@
#+end_src
...
#+begin_src org
,#+MACRO: ik  @@latex:\index{$1}\keys{$1}\xspace{}@@@@html:<kbd>$1</kbd>@@
#+end_src
...
The ~i~ macro creates an index entry when exporting to LaTeX.
