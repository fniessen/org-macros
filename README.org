...
#+begin_warning
ODT requirements -- For ODT export, this macro relies on a custom paragraph
style named ~PageBreak~. This style must be defined in the ~styles.xml~ file of the
...
,#+MACRO: kbd @@latex:\keys{$1}\xspace{}@@ @@html:<kbd>$1</kbd>@@
#+end_src
...
#+begin_src org
,#+MACRO: ikbd  @@latex:\index{$1}\keys{$1}\xspace{}@@ @@html:<kbd>$1</kbd>@@
#+end_src
...
#+begin_src org
,#+MACRO: idx @@latex:\index{$1}\xspace{}@@
#+end_src
