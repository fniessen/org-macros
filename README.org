...
The ~k~ macro formats a keyboard shortcut. It is intended for inline keyboard
notation.
...
The ~ik~ macro formats a keyboard shortcut and simultaneously creates an index
