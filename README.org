...
Load the macro definitions via:

#+begin_src org :tangle no
,#+INCLUDE:   /PATH/TO/org/setup/org-macros.setup
#+end_src
...
#+begin_src org
,#+MACRO: bgcolor @@latex:\colorbox{$1}{$2}@@ @@html:<div style="background-color: $1;">$2</div>@@
#+end_src
...
a single frame into multiple slides at a precise point.
...
The ~fixme~ macro inserts a visible "FIXME" marker, with CSS available for
customizing its appearance.

*** Code

#+begin_src org
,#+MACRO: fixme @@latex:\textcolor{red}{\textbf{FIXME}}@@ @@html:<span class="fixme">FIXME</span>@@
#+end_src
...
#+begin_src org
,#+MACRO: highlight @@latex:\colorbox{$1}{$2}@@ @@html:<span style="background-color: $1;">$2</span>@@
#+end_src
...
The ~redact~ macro conceals inline text in HTML export by applying a black
foreground and background color, making the text appear as a black box.

*** Code

#+begin_src org
,#+MACRO: redact @@latex:\colorbox{black}{\textcolor{black}{$1}}@@ @@html:<span class="redact" style="color:black; background-color:black;">$1</span>@@
#+end_src
...
** Git-version macro
:PROPERTIES:
:CUSTOM_ID: git-version
:END:

The ~git-version~ macro returns the Git version for the repository containing the
exported file. It uses the nearest tag when one is available, otherwise it
returns the abbreviated commit ID. A dirty working tree is marked with ~-dirty~.

If the file is not inside a Git repository, or Git cannot provide a version, the
macro returns ~unknown~.

*** Code

#+begin_src org
,#+MACRO: git-version (eval (let* ((file (or (and (boundp 'org-export-current-file) org-export-current-file) (buffer-file-name))) (directory (file-name-directory (or file default-directory))) (root (and directory (locate-dominating-file directory ".git")))) (if root (with-temp-buffer (if (= 0 (call-process "git" nil t nil "-C" (expand-file-name root) "describe" "--tags" "--always" "--dirty")) (replace-regexp-in-string "[\n\r]+\\'" "" (buffer-string)) "unknown")) "unknown")))
#+end_src
...
This document was generated from Git version {{{git-version}}}.

*** Requirements

Git must be installed and available on ~PATH~. Macro evaluation must be enabled
...
#+begin_src org
,#+MACRO: begin_collapse @@latex:\par\noindent\textbf{$1}\par@@ @@html:<details><summary>$1</summary>@@
,#+MACRO: end_collapse @@latex:\par@@ @@html:</details>@@
#+end_src
...
#+begin_src org
,#+MACRO: begin_info @@latex:\par\noindent\textbf{Info:} @@ @@html:<div class="info"><p>@@
,#+MACRO: end_info @@latex:\par@@ @@html:</p></div>@@
#+end_src
...
#+begin_src org
,#+MACRO: begin_minipage @@latex:\begin{center}\begin{minipage}{0.95\linewidth}@@ @@html:<div style="border:1px solid #aaaaaa;padding:10px;width:780px;margin-left:auto;margin-right:auto;">@@
,#+MACRO: end_minipage @@latex:\end{minipage}\end{center}@@ @@html:</div>@@
#+end_src
...
#+begin_src org
,#+MACRO: begin_note @@latex:\begin{quote}\textbf{Note:} @@ @@html:<div class="note"><p>@@
,#+MACRO: end_note @@latex:\end{quote}@@ @@html:</p></div>@@
#+end_src
...
#+begin_src org
,#+MACRO: begin_panel @@latex:\begin{quote}@@ @@html:<div class="panel"><p>@@
,#+MACRO: end_panel @@latex:\end{quote}@@ @@html:</p></div>@@
#+end_src
...
#+begin_src org
,#+MACRO: begin_tip @@latex:\begin{quote}\textbf{Tip:} @@ @@html:<div class="tip"><p>@@
,#+MACRO: end_tip @@latex:\end{quote}@@ @@html:</p></div>@@
#+end_src
...
#+begin_src org
,#+MACRO: begin_warning @@latex:\begin{quote}\textbf{Warning:} @@ @@html:<div class="warning"><p>@@
,#+MACRO: end_warning @@latex:\end{quote}@@ @@html:</p></div>@@
#+end_src
