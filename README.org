...
,#+HTML_HEAD: </style>
,#+MACRO: kbd @@latex:{\setlength{\fboxsep}{1.2pt}\setlength{\fboxrule}{0pt}\fcolorbox{black!45}{black!10}{\lstinline[language=shell,basicstyle=\ttfamily\scriptsize]§$1§}}@@ @@html:<kbd class="kbd">$1</kbd>@@
#+end_src
...
,#+HTML_HEAD: </style>
,#+MACRO: ikbd @@latex:\index{$1}{\setlength{\fboxsep}{1.2pt}\setlength{\fboxrule}{0.4pt}\fcolorbox{blue!55!black}{blue!12}{\lstinline[language=shell,basicstyle=\ttfamily\scriptsize]§$1§}}@@ @@html:<kbd class="ikbd">$1</kbd>@@
#+end_src
